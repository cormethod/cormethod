...
const CONFIG = {
  ...
  FORM_ENTRIES: {
    name: 'entry.123456789',    // ← ЗАМЕНИТЬ на реальный entry ID для поля "Имя"
    email: 'entry.987654321',   // ← ЗАМЕНИТЬ на реальный entry ID для поля "Email"
    phone: 'entry.456789123',   // ← ЗАМЕНИТЬ на реальный entry ID для поля "Телефон"
